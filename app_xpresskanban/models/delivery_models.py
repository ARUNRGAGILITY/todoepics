...
class Organization(CoreDelivery):
    work_item_type = TreeForeignKey('app_xpresskanban.TYPE_HSDB', on_delete=models.SET_NULL, null=True, blank=True, related_name="xpress_org_witype")
...
class BoardColumnCardSeq(CoreDelivery):
    board = models.ForeignKey(Board, null=True, blank=True, on_delete=models.SET_NULL)
    column = models.ForeignKey(BoardColumns, null=True, blank=True, on_delete=models.SET_NULL, related_name="bccseq_column")
    card_seq = models.TextField(null=True, blank=True,)
    author = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="xpress_bccseq_author")
    def __str__(self):
        return self.title
